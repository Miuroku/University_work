...
class Packer:
    # Pack an object to dictionary.
    def from_object_to_dictionary(self, obj: object):
        self.metainfo = {}
        self.proceeded = []
        dump = self.dump(obj)
...
class Unpacker:
    # unpack from dict to object.
    def from_dict_to_object(self, src: object, __globals__=globals()):
